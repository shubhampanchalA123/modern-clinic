...
function VideosPage() {
    ...
    const categories = [
        "All",
        ...new Set(videoList.map((v)=>v.category))
    ];
    const filteredVideos = filter === "All" ? videoList : videoList.filter((v)=>v.category === filter);
...
//# sourceMappingURL=app_videos_4b6375c2._.js.map