...
const submitData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("register/submitData", async ({ consultantId, consultationData, scalpPhoto }, thunkAPI)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("bookingconsultancy/submit", data, {
            headers
        });
        return response.data;
    } catch (error) {
...
const createOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("register/createOrder", async ({ consultantId, amount }, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("payments/create-order", {
            consultantId,
            amount
        });
        return response.data;
...
const verifyPayment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("register/verifyPayment", async ({ consultantId, razorpay_payment_id, razorpay_order_id, razorpay_signature }, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("payments/verify", {
            consultantId,
            razorpay_payment_id,
            razorpay_order_id,
            razorpay_signature
...
const registerAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("register/registerAppointment", async (formData, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("register", formData);
        return response.data;
    } catch (error) {
...
const verifyAppointmentOtp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("register/verifyAppointmentOtp", async ({ phone, idToken, appointmentId }, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("verify", {
            phone,
            idToken,
            appointmentId
        });
...
"[project]/HairGrowth-Clinic/redux/slices/appointmentSlice.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const registerAppointment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("appointment/registerAppointment", async (formData, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("appointments/register", formData);
        return response.data;
    } catch (error) {
        return thunkAPI.rejectWithValue(error.response?.data?.message || "Register appointment failed");
    }
...
const verifyAppointmentOtp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("appointment/verifyAppointmentOtp", async ({ phone, idToken, appointmentId }, thunkAPI)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("appointments/verify", {
            phone,
            idToken,
            appointmentId
        });
...
const createAppointmentOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("appointment/createAppointmentOrder", async ({ appointmentId, amount }, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("payments/appointment/create-order", {
            appointmentId,
            amount
        });
        return response.data;
...
const verifyAppointmentPayment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("appointment/verifyAppointmentPayment", async ({ appointmentId, razorpay_payment_id, razorpay_order_id, razorpay_signature }, thunkAPI)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$axiosClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("payments/appointment/verify", {
            appointmentId,
            razorpay_payment_id,
            razorpay_order_id,
            razorpay_signature
...
// ------------------- SLICE -------------------
const appointmentSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: "appointment",
    initialState: {
        loading: false,
        error: null,
...
const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["configureStore"])({
    reducer: {
        ...
        appointment: __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$appointmentSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
    }
});
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72941d42._.js.map