module.exports = [
"[project]/HairGrowth-Clinic/app/payment-method/online/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OnlinePaymentPage() {
    const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSearchParams"])();
    ...
    const { createAppointmentOrderSuccess, orderDetails } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.appointment);
    const [razorpayLoaded, setRazorpayLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isAppointment, setIsAppointment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (appointmentId && appointmentAmount && !orderId) {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$appointmentSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAppointmentOrder"])({
                appointmentId,
    ...
    const handlePayment = ()=>{
        ...
        const options = {
            ...
            handler: function(response) {
                // Payment success
                if (isAppointment) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$appointmentSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyAppointmentPayment"])({
                        appointmentId,
                    ...
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$HairGrowth$2d$Clinic$2f$redux$2f$slices$2f$registerSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyPayment"])({
                        consultantId,
                        razorpay_payment_id: response.razorpay_payment_id,
                        razorpay_order_id: response.razorpay_order_id,
                        razorpay_signature: response.razorpay_signature
...
//# sourceMappingURL=HairGrowth-Clinic_app_payment-method_online_page_jsx_3b712961._.js.map